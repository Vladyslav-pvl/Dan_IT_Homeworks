...
2. В чем разница между функцией prompt и функцией confirm?
	...
	Функция prompt выводит модальное окно для ввода данных и сообщение для пользователя с нужным нам вопросом.
	Функция confirm спрашивает мнение пользователя.
...
*/
let userCity = prompt("In what city have you been born?");

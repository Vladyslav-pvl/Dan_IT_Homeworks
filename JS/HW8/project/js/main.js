...
Як можна звернутися до елемента сторінки за допомогою JS? Який спосіб кращий?
	Самый комфортный и оптимальный вариант поиска элемента по селекторам (класса, id). Ну и так же имеет место быть таким методам как getElementById(), getElementByClassName()
*/
